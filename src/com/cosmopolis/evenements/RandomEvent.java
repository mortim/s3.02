    ...
    public String createEvent() {
        ...
        switch(this.evenement) {
            ...
            case TEMPETE:
                ...
                msg = "Une Tempête sans précédent vient de toucher votre ville. \nLes dégâts sont considérables... Vous perdez "+v5+" batiments et "+(vv4-v4)+" de vos habitants sont morts.";
                break;
            case BONVIVRE:
            ...
            case SEISME:
                ...
                msg = "Un terrible séisme s'est abatut sur votre ville ! \nLes dégâts sont considérables... Vous perdez "+v8+" batiments et "+(vv6-v7)+" de vos habitants sont morts.";
                break;
            case INCENDIE:
