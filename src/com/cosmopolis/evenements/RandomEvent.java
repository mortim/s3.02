    ...
    public String createEvent() {
        ...
        switch(this.evenement) {
            ...
            case MOURRANT:
                ...
                msg = "La vie est courte non ? "+Math.abs((vv1-v1))+" de vos habitants sont décédés.";
                break;
            case TOURISTE:
                int v2 = (int)(ville.getResidents()* 1.8 + (r.nextDouble() + (2.2 - 1.8)));
                int vv2 = ville.getResidents();
                ville.setResidents(v2);
                msg = "Votre ville est si belle qu'elle accueille "+Math.abs((vv2-v2))+" touristes ! Attention au facteur de surpopulation.";
                break;
            case SURPOPULATION:
                int v3 = (int)(ville.getResidents()* 0.6 + (r.nextDouble() + (0.4 - (0.6))));
                int vv3 = ville.getResidents();
                ville.setResidents(v3);
                msg = "Votre ville à dépassé son seuil de peuplement. C'est désastreux, "+Math.abs((vv3-v3))+" de vos habitants sont morts.";
                break;
            case TEMPETE:
                ...
                msg = "Une Tempête sans précédent vient de toucher votre ville. \nLes dégâts sont considérables... Vous perdez "+v5+" batiments et "+Math.abs((vv4-v4))+" de vos habitants sont morts.";
                break;
            case BONVIVRE:
                int v6 = (int)(ville.getResidents()* 1.4 + (r.nextDouble() + (1.5 - (1.4))));
                int vv5 = ville.getResidents();
                ville.setResidents(v6);
                msg = "Il fait bon vivre dans votre ville ! "+Math.abs((vv5-v6))+" personnes décident de s'installer.";
                break;
            case SEISME:
                ...
                msg = "Un terrible séisme s'est abatut sur votre ville ! \nLes dégâts sont considérables... Vous perdez "+v8+" batiments et "+Math.abs((vv6-v7))+" de vos habitants sont morts.";
                break;
            case INCENDIE:
                ...
                msg = "Un incendie vient de se déclencher dans votre ville ! Les dégâts sont considérables... Vous perdez "+v10+" batiments et "+Math.abs((vv7-v9))+" de vos habitants sont morts.";
                break;
            case BRAQUAGE:
                int v11 = (int)(ville.getMoney() * 0.9 + (r.nextDouble() + (0.8 - (0.9))));
                double v12 = ville.getMoney();
                ville.setMoney(v11);
                msg = "Un groupe de cambrioleur, qui convoitait votre patrimoine, est parvenu à chapparder votre argent ! Vous perdez "+Math.abs((v12-v11))+"$.";
                break;
        }
        return msg;
    }
